...
describe "ActivatePowerMode", ->
  ...
  beforeEach ->
    ...
    activationPromise = atom.packages.activatePackage('activate-power-mode')

  describe "when the activate-power-mode:toggle event is triggered", ->
    it "hides and shows the modal panel", ->
      ...
      runs ->
        ...
        atom.commands.dispatch workspaceElement, 'activate-power-mode:toggle'
        expect(activatePowerModePanel.isVisible()).toBe false
    ...
    it "hides and shows the view", ->
      ...
      runs ->
        ...
        atom.commands.dispatch workspaceElement, 'activate-power-mode:toggle'
        expect(activatePowerModeElement).not.toBeVisible()
